...
public class AIMaterial extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIMaterial, Buffer> implements NativeResource {
        ...
        public Buffer mProperties(@NativeType("struct aiMaterialProperty **") PointerBuffer value) { AIMaterial.nmProperties(address(), value); return this; }
        /** Sets the specified value to the {@link AIMaterial#mNumAllocated} field. */
        public Buffer mNumAllocated(@NativeType("unsigned int") int value) { AIMaterial.nmNumAllocated(address(), value); return this; }
