...
public class PlaneGenerator {
    ...
    public static <V extends MultiRenderObject<T>, T extends MeshObject> void createPlaneMeshObject(V objects, Supplier<T> supplier, HashMap<String, Material> materials, int width, int length) {
        var model = new GLModel();
        ...
        var mesh = supplier.get();
        objects.add(mesh);
        mesh.setup(materials, new ArrayList<>(), new HashMap<>(), model, "material_preview");
    }
