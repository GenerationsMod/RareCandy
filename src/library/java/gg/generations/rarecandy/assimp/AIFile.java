...
public class AIFile extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIFile, Buffer> implements NativeResource {
        ...
        public Buffer ReadProc(@NativeType("aiFileReadProc") AIFileReadProcI value) { AIFile.nReadProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFile#WriteProc} field. */
        public Buffer WriteProc(@NativeType("aiFileWriteProc") AIFileWriteProcI value) { AIFile.nWriteProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFile#TellProc} field. */
        public Buffer TellProc(@NativeType("aiFileTellProc") AIFileTellProcI value) { AIFile.nTellProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFile#FileSizeProc} field. */
        public Buffer FileSizeProc(@NativeType("aiFileTellProc") AIFileTellProcI value) { AIFile.nFileSizeProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFile#SeekProc} field. */
        public Buffer SeekProc(@NativeType("aiFileSeek") AIFileSeekI value) { AIFile.nSeekProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFile#FlushProc} field. */
        public Buffer FlushProc(@NativeType("aiFileFlushProc") AIFileFlushProcI value) { AIFile.nFlushProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFile#UserData} field. */
        public Buffer UserData(@NativeType("aiUserData") long value) { AIFile.nUserData(address(), value); return this; }
