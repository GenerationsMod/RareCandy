...
public final class SMDI extends Table {
  ...
  public static SMDI getRootAsSMDI(ByteBuffer _bb) { return getRootAsSMDI(_bb, new SMDI()); }
  public static SMDI getRootAsSMDI(ByteBuffer _bb, SMDI obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public SMDI __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Keyframe keyframes(int j) { return keyframes(new Keyframe(), j); }
  public Keyframe keyframes(Keyframe obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int keyframesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public Keyframe.Vector keyframesVector() { return keyframesVector(new Keyframe.Vector()); }
  public Keyframe.Vector keyframesVector(Keyframe.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public static void startSMDI(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static void finishSMDIBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedSMDIBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SMDI get(int j) { return get(new SMDI(), j); }
    public SMDI get(SMDI obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public SMDIT unpack() {
    SMDIT _o = new SMDIT();
    unpackTo(_o);
  ...
  public void unpackTo(SMDIT _o) {
    ...
    for (int _j = 0; _j < keyframesLength(); ++_j) {_oKeyframes[_j] = (keyframes(_j) != null ? keyframes(_j).unpack() : null);}
  ...
  public static int pack(FlatBufferBuilder builder, SMDIT _o) {
    ...
    if (_o.getBones() != null) {
      ...
      int _j = 0;
      for (BoneT _e : _o.getBones()) { __bones[_j] = Bone.pack(builder, _e); _j++;}
    ...
    if (_o.getKeyframes() != null) {
      ...
      int _j = 0;
      for (KeyframeT _e : _o.getKeyframes()) { __keyframes[_j] = Keyframe.pack(builder, _e); _j++;}
