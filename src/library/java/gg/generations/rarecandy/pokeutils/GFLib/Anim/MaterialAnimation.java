...
public final class MaterialAnimation extends Table {
    ...
    public static MaterialAnimation getRootAsMaterialAnimation(ByteBuffer _bb) {
        return getRootAsMaterialAnimation(_bb, new MaterialAnimation());
    }

    public static MaterialAnimation getRootAsMaterialAnimation(ByteBuffer _bb, MaterialAnimation obj) {
    ...
    public MaterialAnimation __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public MaterialTrack tracks(int j) {
        return tracks(new MaterialTrack(), j);
    }

    public MaterialTrack tracks(MaterialTrack obj, int j) {
        int o = __offset(4);
    ...
    public MaterialTrack.Vector tracksVector() {
        return tracksVector(new MaterialTrack.Vector());
    }

    public MaterialTrack.Vector tracksVector(MaterialTrack.Vector obj) {
        int o = __offset(4);
    ...
    public static void startMaterialAnimation(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MaterialAnimation get(int j) {
            return get(new MaterialAnimation(), j);
        }

        public MaterialAnimation get(MaterialAnimation obj, int j) {
    ...
    public static int pack(FlatBufferBuilder builder, MaterialAnimationT _o) {
        ...
        if (_o.getTracks() != null) {
            ...
            int _j = 0;
            for (MaterialTrackT _e : _o.getTracks()) {
                __tracks[_j] = MaterialTrack.pack(builder, _e);
                _j++;
            }
