...
public final class SkinAnimation extends Table {
  ...
  public static SkinAnimation getRootAsSkinAnimation(ByteBuffer _bb) { return getRootAsSkinAnimation(_bb, new SkinAnimation()); }
  public static SkinAnimation getRootAsSkinAnimation(ByteBuffer _bb, SkinAnimation obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public SkinAnimation __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public SkinTrack tracks(int j) { return tracks(new SkinTrack(), j); }
  public SkinTrack tracks(SkinTrack obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int tracksLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public SkinTrack.Vector tracksVector() { return tracksVector(new SkinTrack.Vector()); }
  public SkinTrack.Vector tracksVector(SkinTrack.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public static void startSkinAnimation(FlatBufferBuilder builder) { builder.startTable(1); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public SkinAnimation get(int j) { return get(new SkinAnimation(), j); }
    public SkinAnimation get(SkinAnimation obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  ...
  public static int pack(FlatBufferBuilder builder, SkinAnimationT _o) {
    ...
    if (_o.getTracks() != null) {
      ...
      int _j = 0;
      for (SkinTrackT _e : _o.getTracks()) { __tracks[_j] = SkinTrack.pack(builder, _e); _j++;}
