...
public class AIMeshMorphKey extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIMeshMorphKey, Buffer> implements NativeResource {
        ...
        public Buffer mTime(double value) { AIMeshMorphKey.nmTime(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@link AIMeshMorphKey#mValues} field. */
        public Buffer mValues(@NativeType("unsigned int *") IntBuffer value) { AIMeshMorphKey.nmValues(address(), value); return this; }
        /** Sets the address of the specified {@link DoubleBuffer} to the {@link AIMeshMorphKey#mWeights} field. */
        public Buffer mWeights(@NativeType("double *") DoubleBuffer value) { AIMeshMorphKey.nmWeights(address(), value); return this; }
        /** Sets the specified value to the {@link AIMeshMorphKey#mNumValuesAndWeights} field. */
        public Buffer mNumValuesAndWeights(@NativeType("unsigned int") int value) { AIMeshMorphKey.nmNumValuesAndWeights(address(), value); return this; }
