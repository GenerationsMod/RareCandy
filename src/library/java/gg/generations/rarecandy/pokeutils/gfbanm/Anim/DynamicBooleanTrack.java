...
public final class DynamicBooleanTrack extends Table {
    ...
    public static DynamicBooleanTrack getRootAsDynamicBooleanTrack(ByteBuffer _bb) {
        return getRootAsDynamicBooleanTrack(_bb, new DynamicBooleanTrack());
    }

    public static DynamicBooleanTrack getRootAsDynamicBooleanTrack(ByteBuffer _bb, DynamicBooleanTrack obj) {
    ...
    public DynamicBooleanTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void addBool(FlatBufferBuilder builder, int boolOffset) {
        builder.addOffset(0, boolOffset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public DynamicBooleanTrack get(int j) {
            return get(new DynamicBooleanTrack(), j);
        }

        public DynamicBooleanTrack get(DynamicBooleanTrack obj, int j) {
