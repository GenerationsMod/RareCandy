...
public class AIVector3D extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIVector3D, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code x} field. */
        public Buffer x(float value) { AIVector3D.nx(address(), value); return this; }
        /** Sets the specified value to the {@code y} field. */
        public Buffer y(float value) { AIVector3D.ny(address(), value); return this; }
        /** Sets the specified value to the {@code z} field. */
        public Buffer z(float value) { AIVector3D.nz(address(), value); return this; }
