...
public final class Condition extends Table {
  ...
  public static Condition getRootAsCondition(ByteBuffer _bb, Condition obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public long func() { int o = __offset(6); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  public byte valueType() { int o = __offset(8); return o != 0 ? bb.get(o + bb_pos) : 0; }
  public Table value(Table obj) { int o = __offset(10); return o != 0 ? __union(obj, o + bb_pos) : null; }
  ...
  public static void startCondition(FlatBufferBuilder builder) { builder.startTable(4); }
  public static void addName(FlatBufferBuilder builder, int nameOffset) { builder.addOffset(0, nameOffset, 0); }
  public static void addFunc(FlatBufferBuilder builder, long func) { builder.addInt(1, (int) func, (int) 0L); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Condition get(int j) { return get(new Condition(), j); }
    public Condition get(Condition obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
