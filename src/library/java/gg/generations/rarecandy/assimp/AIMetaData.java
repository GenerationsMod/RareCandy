...
public class AIMetaData extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIMetaData, Buffer> implements NativeResource {
        ...
        public Buffer mNumProperties(@NativeType("unsigned int") int value) { AIMetaData.nmNumProperties(address(), value); return this; }
        /** Sets the address of the specified {@link AIString.Buffer} to the {@link AIMetaData#mKeys} field. */
        public Buffer mKeys(@NativeType("struct aiString *") AIString.Buffer value) { AIMetaData.nmKeys(address(), value); return this; }
        /** Sets the address of the specified {@link AIMetaDataEntry.Buffer} to the {@link AIMetaData#mValues} field. */
        public Buffer mValues(@NativeType("struct aiMetadataEntry *") AIMetaDataEntry.Buffer value) { AIMetaData.nmValues(address(), value); return this; }
