...
public final class Vec4s extends Struct {
    ...
    public Vec4s __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public int w() {
        return bb.getShort(bb_pos + 6) & 0xFFFF;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Vec4s get(int j) {
            return get(new Vec4s(), j);
        }

        public Vec4s get(Vec4s obj, int j) {
