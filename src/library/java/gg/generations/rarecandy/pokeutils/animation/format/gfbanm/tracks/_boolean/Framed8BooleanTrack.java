...
public final class Framed8BooleanTrack extends Table {
  ...
  public static Framed8BooleanTrack getRootAsFramed8BooleanTrack(ByteBuffer _bb) { return getRootAsFramed8BooleanTrack(_bb, new Framed8BooleanTrack()); }
  public static Framed8BooleanTrack getRootAsFramed8BooleanTrack(ByteBuffer _bb, Framed8BooleanTrack obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public Framed8BooleanTrack __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startFramed8BooleanTrack(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Framed8BooleanTrack get(int j) { return get(new Framed8BooleanTrack(), j); }
    public Framed8BooleanTrack get(Framed8BooleanTrack obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
