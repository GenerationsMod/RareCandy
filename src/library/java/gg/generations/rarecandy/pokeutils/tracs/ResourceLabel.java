...
public final class ResourceLabel extends Table {
  ...
  public static ResourceLabel getRootAsResourceLabel(ByteBuffer _bb, ResourceLabel obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public long resourceType() { int o = __offset(6); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  ...
  public static void addResourceType(FlatBufferBuilder builder, long resourceType) { builder.addInt(1, (int) resourceType, (int) 0L); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public ResourceLabel get(int j) { return get(new ResourceLabel(), j); }
    public ResourceLabel get(ResourceLabel obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
