...
public class AINodeAnim extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AINodeAnim, Buffer> implements NativeResource {
        ...
        public Buffer mNodeName(@NativeType("struct aiString") AIString value) { AINodeAnim.nmNodeName(address(), value); return this; }
        /** Passes the {@link AINodeAnim#mNodeName} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mNodeName(java.util.function.Consumer<AIString> consumer) { consumer.accept(mNodeName()); return this; }
        /** Sets the address of the specified {@link AIVectorKey.Buffer} to the {@link AINodeAnim#mPositionKeys} field. */
        public Buffer mPositionKeys(@Nullable @NativeType("struct aiVectorKey *") AIVectorKey.Buffer value) { AINodeAnim.nmPositionKeys(address(), value); return this; }
        /** Sets the address of the specified {@link AIQuatKey.Buffer} to the {@link AINodeAnim#mRotationKeys} field. */
        public Buffer mRotationKeys(@Nullable @NativeType("struct aiQuatKey *") AIQuatKey.Buffer value) { AINodeAnim.nmRotationKeys(address(), value); return this; }
        /** Sets the address of the specified {@link AIVectorKey.Buffer} to the {@link AINodeAnim#mScalingKeys} field. */
        public Buffer mScalingKeys(@Nullable @NativeType("struct aiVectorKey *") AIVectorKey.Buffer value) { AINodeAnim.nmScalingKeys(address(), value); return this; }
        /** Sets the specified value to the {@link AINodeAnim#mPreState} field. */
        public Buffer mPreState(@NativeType("aiAnimBehaviour") int value) { AINodeAnim.nmPreState(address(), value); return this; }
        /** Sets the specified value to the {@link AINodeAnim#mPostState} field. */
        public Buffer mPostState(@NativeType("aiAnimBehaviour") int value) { AINodeAnim.nmPostState(address(), value); return this; }
