...
public final class Node_Root extends Table {
    ...
    public static Node_Root getRootAsNode_Root(ByteBuffer _bb) {
        return getRootAsNode_Root(_bb, new Node_Root());
    }

    public static Node_Root getRootAsNode_Root(ByteBuffer _bb, Node_Root obj) {
    ...
    public Node_Root __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public Node_Child children(int j) {
        return children(new Node_Child(), j);
    }

    public Node_Child children(Node_Child obj, int j) {
        int o = __offset(4);
    ...
    public Node_Child.Vector childrenVector() {
        return childrenVector(new Node_Child.Vector());
    }

    public Node_Child.Vector childrenVector(Node_Child.Vector obj) {
        int o = __offset(4);
        return o != 0 ? obj.__assign(__vector(o), 4, bb) : null;
    }

    public Channels channels() {
        return channels(new Channels());
    }

    public Channels channels(Channels obj) {
        int o = __offset(6);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }

    public String name(int j) {
        int o = __offset(8);
    ...
    public StringVector nameVector() {
        return nameVector(new StringVector());
    }

    public StringVector nameVector(StringVector obj) {
        int o = __offset(8);
        return o != 0 ? obj.__assign(__vector(o), 4, bb) : null;
    }
    ...
    public static void startNode_Root(FlatBufferBuilder builder) {
        builder.startTable(3);
    }

    public static void addChildren(FlatBufferBuilder builder, int childrenOffset) {
        builder.addOffset(0, childrenOffset, 0);
    }
    ...
    public static void addChannels(FlatBufferBuilder builder, int channelsOffset) {
        builder.addOffset(1, channelsOffset, 0);
    }
    ...
    public static int createNameVector(FlatBufferBuilder builder, int[] data) {
        builder.startVector(4, data.length, 4);
        for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]);
        return builder.endVector();
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Node_Root get(int j) {
            return get(new Node_Root(), j);
        }

        public Node_Root get(Node_Root obj, int j) {
    ...
    public void unpackTo(Node_RootT _o) {
        ...
        for (int _j = 0; _j < childrenLength(); ++_j) {
            _oChildren[_j] = (children(_j) != null ? children(_j).unpack() : null);
        }
    ...
    public static int pack(FlatBufferBuilder builder, Node_RootT _o) {
        ...
        if (_o.getChildren() != null) {
            ...
            int _j = 0;
            for (Node_ChildT _e : _o.getChildren()) {
                __children[_j] = Node_Child.pack(builder, _e);
                _j++;
            }
        ...
        if (_o.getName() != null) {
            ...
            int _j = 0;
            for (String _e : _o.getName()) {
                __name[_j] = builder.createString(_e);
                _j++;
            }
