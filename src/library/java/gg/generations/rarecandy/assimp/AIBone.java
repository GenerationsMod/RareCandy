...
public class AIBone extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIBone, Buffer> implements NativeResource {
        ...
        public Buffer mName(@NativeType("struct aiString") AIString value) { AIBone.nmName(address(), value); return this; }
        ...
        public Buffer mArmature(@NativeType("struct aiNode *") AINode value) { AIBone.nmArmature(address(), value); return this; }
        /** Sets the address of the specified {@link AINode} to the {@link AIBone#mNode} field. */
        public Buffer mNode(@NativeType("struct aiNode *") AINode value) { AIBone.nmNode(address(), value); return this; }
        /** Sets the address of the specified {@link AIVertexWeight.Buffer} to the {@link AIBone#mWeights} field. */
        public Buffer mWeights(@NativeType("struct aiVertexWeight *") AIVertexWeight.Buffer value) { AIBone.nmWeights(address(), value); return this; }
        /** Copies the specified {@link AIMatrix4x4} to the {@link AIBone#mOffsetMatrix} field. */
        public Buffer mOffsetMatrix(@NativeType("struct aiMatrix4x4") AIMatrix4x4 value) { AIBone.nmOffsetMatrix(address(), value); return this; }
