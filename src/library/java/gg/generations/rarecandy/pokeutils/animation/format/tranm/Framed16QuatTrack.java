...
public final class Framed16QuatTrack extends Table {
    ...
    public static Framed16QuatTrack getRootAsFramed16QuatTrack(ByteBuffer _bb) {
        return getRootAsFramed16QuatTrack(_bb, new Framed16QuatTrack());
    }

    public static Framed16QuatTrack getRootAsFramed16QuatTrack(ByteBuffer _bb, Framed16QuatTrack obj) {
    ...
    public static void startFramed16QuatTrack(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static void addVec(FlatBufferBuilder builder, int vecOffset) {
        builder.addOffset(1, vecOffset, 0);
    }
    ...
    public Framed16QuatTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public Vec3s vec(int j) {
        return vec(new Vec3s(), j);
    }

    public Vec3s vec(Vec3s obj, int j) {
        int o = __offset(6);
    ...
    public Vec3s.Vector vecVector() {
        return vecVector(new Vec3s.Vector());
    }

    public Vec3s.Vector vecVector(Vec3s.Vector obj) {
        int o = __offset(6);
    ...
    public static final class Vector extends BaseVector {
        ...
        public Framed16QuatTrack get(int j) {
            return get(new Framed16QuatTrack(), j);
        }

        public Framed16QuatTrack get(Framed16QuatTrack obj, int j) {
