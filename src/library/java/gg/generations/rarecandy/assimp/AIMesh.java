...
public class AIMesh extends Struct implements NativeResource {
    ...
    /** Passes the {@link #mAABB} field to the specified {@link Consumer Consumer}. */
    public AIMesh mAABB(Consumer<AIAABB> consumer) { consumer.accept(mAABB()); return this; }
    ...
    @Nullable public static AIColor4D.Buffer nmColors(long struct, int index) {
        return AIColor4D.createSafe(memGetAddress(struct + AIMesh.MCOLORS + Checks.check(index, Assimp.AI_MAX_NUMBER_OF_COLOR_SETS) * POINTER_SIZE), nmNumVertices(struct));
    }
    ...
    @Nullable public static AIVector3D.Buffer nmTextureCoords(long struct, int index) {
        return AIVector3D.createSafe(memGetAddress(struct + AIMesh.MTEXTURECOORDS + Checks.check(index, Assimp.AI_MAX_NUMBER_OF_TEXTURECOORDS) * POINTER_SIZE), nmNumVertices(struct));
    }
    ...
    public static int nmNumUVComponents(long struct, int index) {
        return UNSAFE.getInt(null, struct + AIMesh.MNUMUVCOMPONENTS + Checks.check(index, Assimp.AI_MAX_NUMBER_OF_TEXTURECOORDS) * 4);
    }
    ...
    @Nullable public static PointerBuffer nmTextureCoordsNames(long struct) { return memPointerBufferSafe(memGetAddress(struct + AIMesh.MTEXTURECOORDSNAMES), Assimp.AI_MAX_NUMBER_OF_TEXTURECOORDS); }
    ...
    public static void nmColors(long struct, PointerBuffer value) {
        if (CHECKS) { Checks.checkGT(value, Assimp.AI_MAX_NUMBER_OF_COLOR_SETS); }
    ...
    public static void nmColors(long struct, int index, @Nullable AIColor4D.Buffer value) {
        memPutAddress(struct + AIMesh.MCOLORS + Checks.check(index, Assimp.AI_MAX_NUMBER_OF_COLOR_SETS) * POINTER_SIZE, memAddressSafe(value));
    }
    ...
    public static void nmTextureCoords(long struct, PointerBuffer value) {
        if (CHECKS) { Checks.checkGT(value, Assimp.AI_MAX_NUMBER_OF_TEXTURECOORDS); }
    ...
    public static void nmTextureCoords(long struct, int index, @Nullable AIVector3D.Buffer value) {
        memPutAddress(struct + AIMesh.MTEXTURECOORDS + Checks.check(index, Assimp.AI_MAX_NUMBER_OF_TEXTURECOORDS) * POINTER_SIZE, memAddressSafe(value));
    }
    ...
    public static void nmNumUVComponents(long struct, int index, int value) {
        UNSAFE.putInt(null, struct + AIMesh.MNUMUVCOMPONENTS + Checks.check(index, Assimp.AI_MAX_NUMBER_OF_TEXTURECOORDS) * 4, value);
    }
    ...
    public static class Buffer extends StructBuffer<AIMesh, Buffer> implements NativeResource {
        ...
        public Buffer mPrimitiveTypes(@NativeType("unsigned int") int value) { AIMesh.nmPrimitiveTypes(address(), value); return this; }
        /** Sets the specified value to the {@link AIMesh#mNumVertices} field. */
        public Buffer mNumVertices(@NativeType("unsigned int") int value) { AIMesh.nmNumVertices(address(), value); return this; }
        /** Sets the address of the specified {@link AIVector3D.Buffer} to the {@link AIMesh#mVertices} field. */
        public Buffer mVertices(@NativeType("struct aiVector3D *") AIVector3D.Buffer value) { AIMesh.nmVertices(address(), value); return this; }
        /** Sets the address of the specified {@link AIVector3D.Buffer} to the {@link AIMesh#mNormals} field. */
        public Buffer mNormals(@Nullable @NativeType("struct aiVector3D *") AIVector3D.Buffer value) { AIMesh.nmNormals(address(), value); return this; }
        /** Sets the address of the specified {@link AIVector3D.Buffer} to the {@link AIMesh#mTangents} field. */
        public Buffer mTangents(@Nullable @NativeType("struct aiVector3D *") AIVector3D.Buffer value) { AIMesh.nmTangents(address(), value); return this; }
        /** Sets the address of the specified {@link AIVector3D.Buffer} to the {@link AIMesh#mBitangents} field. */
        public Buffer mBitangents(@Nullable @NativeType("struct aiVector3D *") AIVector3D.Buffer value) { AIMesh.nmBitangents(address(), value); return this; }
        /** Copies the specified {@link PointerBuffer} to the {@link AIMesh#mColors} field. */
        public Buffer mColors(@NativeType("struct aiColor4D *[AI_MAX_NUMBER_OF_COLOR_SETS]") PointerBuffer value) { AIMesh.nmColors(address(), value); return this; }
        /** Copies the address of the specified {@link AIColor4D.Buffer} at the specified index of the {@link AIMesh#mColors} field. */
        public Buffer mColors(int index, @Nullable @NativeType("struct aiColor4D *") AIColor4D.Buffer value) { AIMesh.nmColors(address(), index, value); return this; }
        ...
        public Buffer mColors(int index, java.util.function.Consumer<AIColor4D.Buffer> consumer) { consumer.accept(mColors(index)); return this; }
        /** Copies the specified {@link PointerBuffer} to the {@link AIMesh#mTextureCoords} field. */
        public Buffer mTextureCoords(@NativeType("struct aiVector3D *[AI_MAX_NUMBER_OF_TEXTURECOORDS]") PointerBuffer value) { AIMesh.nmTextureCoords(address(), value); return this; }
        ...
        public Buffer mTextureCoords(int index, @Nullable @NativeType("struct aiVector3D *") AIVector3D.Buffer value) { AIMesh.nmTextureCoords(address(), index, value); return this; }
        ...
        public Buffer mTextureCoords(int index, java.util.function.Consumer<AIVector3D.Buffer> consumer) { consumer.accept(mTextureCoords(index)); return this; }
        /** Copies the specified {@link IntBuffer} to the {@link AIMesh#mNumUVComponents} field. */
        public Buffer mNumUVComponents(@NativeType("unsigned int[AI_MAX_NUMBER_OF_TEXTURECOORDS]") IntBuffer value) { AIMesh.nmNumUVComponents(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@link AIMesh#mNumUVComponents} field. */
        public Buffer mNumUVComponents(int index, @NativeType("unsigned int") int value) { AIMesh.nmNumUVComponents(address(), index, value); return this; }
        /** Sets the address of the specified {@link AIFace.Buffer} to the {@link AIMesh#mFaces} field. */
        public Buffer mFaces(@NativeType("struct aiFace *") AIFace.Buffer value) { AIMesh.nmFaces(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIMesh#mBones} field. */
        public Buffer mBones(@Nullable @NativeType("struct aiBone **") PointerBuffer value) { AIMesh.nmBones(address(), value); return this; }
        /** Sets the specified value to the {@link AIMesh#mMaterialIndex} field. */
        public Buffer mMaterialIndex(@NativeType("unsigned int") int value) { AIMesh.nmMaterialIndex(address(), value); return this; }
        /** Copies the specified {@link AIString} to the {@link AIMesh#mName} field. */
        public Buffer mName(@NativeType("struct aiString") AIString value) { AIMesh.nmName(address(), value); return this; }
        /** Passes the {@link AIMesh#mName} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mName(java.util.function.Consumer<AIString> consumer) { consumer.accept(mName()); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIMesh#mAnimMeshes} field. */
        public Buffer mAnimMeshes(@Nullable @NativeType("struct aiAnimMesh **") PointerBuffer value) { AIMesh.nmAnimMeshes(address(), value); return this; }
        /** Sets the specified value to the {@link AIMesh#mMethod} field. */
        public Buffer mMethod(@NativeType("aiMorphingMethod") int value) { AIMesh.nmMethod(address(), value); return this; }
        /** Copies the specified {@link AIAABB} to the {@link AIMesh#mAABB} field. */
        public Buffer mAABB(@NativeType("struct aiAABB") AIAABB value) { AIMesh.nmAABB(address(), value); return this; }
        /** Passes the {@link AIMesh#mAABB} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mAABB(java.util.function.Consumer<AIAABB> consumer) { consumer.accept(mAABB()); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIMesh#mTextureCoordsNames} field. */
        public Buffer mTextureCoordsNames(@Nullable @NativeType("struct aiString **") PointerBuffer value) { AIMesh.nmTextureCoordsNames(address(), value); return this; }
