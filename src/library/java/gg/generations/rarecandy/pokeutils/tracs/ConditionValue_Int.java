...
public final class ConditionValue_Int extends Table {
    ...
    public static ConditionValue_Int getRootAsConditionValue_Int(ByteBuffer _bb) {
        return getRootAsConditionValue_Int(_bb, new ConditionValue_Int());
    }

    public static ConditionValue_Int getRootAsConditionValue_Int(ByteBuffer _bb, ConditionValue_Int obj) {
    ...
    public ConditionValue_Int __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startConditionValue_Int(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ConditionValue_Int get(int j) {
            return get(new ConditionValue_Int(), j);
        }

        public ConditionValue_Int get(ConditionValue_Int obj, int j) {
