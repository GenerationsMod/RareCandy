...
public final class Framed8FloatTrack extends Table {
    ...
    public static Framed8FloatTrack getRootAsFramed8FloatTrack(ByteBuffer _bb) {
        return getRootAsFramed8FloatTrack(_bb, new Framed8FloatTrack());
    }

    public static Framed8FloatTrack getRootAsFramed8FloatTrack(ByteBuffer _bb, Framed8FloatTrack obj) {
    ...
    public Framed8FloatTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startFramed8FloatTrack(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static void addFloat(FlatBufferBuilder builder, int float_Offset) {
        builder.addOffset(1, float_Offset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Framed8FloatTrack get(int j) {
            return get(new Framed8FloatTrack(), j);
        }

        public Framed8FloatTrack get(Framed8FloatTrack obj, int j) {
