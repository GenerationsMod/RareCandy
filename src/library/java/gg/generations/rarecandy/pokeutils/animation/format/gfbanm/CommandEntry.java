...
import gg.generations.rarecandy.pokeutils.animation.format.gfbanm.tracks.data.*;
...
public final class CommandEntry extends Table {
  ...
  public static CommandEntry getRootAsCommandEntry(ByteBuffer _bb, CommandEntry obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public byte tracksType() { int o = __offset(6); return o != 0 ? bb.get(o + bb_pos) : 0; }
  public Table tracks(Table obj) { int o = __offset(8); return o != 0 ? __union(obj, o + bb_pos) : null; }
  ...
  public static void startCommandEntry(FlatBufferBuilder builder) { builder.startTable(3); }
  public static void addName(FlatBufferBuilder builder, int nameOffset) { builder.addOffset(0, nameOffset, 0); }
  public static void addTracksType(FlatBufferBuilder builder, byte tracksType) { builder.addByte(1, tracksType, 0); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public CommandEntry get(int j) { return get(new CommandEntry(), j); }
    public CommandEntry get(CommandEntry obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
