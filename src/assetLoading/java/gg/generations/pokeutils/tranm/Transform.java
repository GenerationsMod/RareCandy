...
public final class Transform extends Struct {
    ...
    public Vec3f scale() {
        return scale(new Vec3f());
    }

    public Vec3f scale(Vec3f obj) {
        return obj.__assign(bb_pos, bb);
    }

    public Vec4f rotate() {
        return rotate(new Vec4f());
    }

    public Vec4f rotate(Vec4f obj) {
        return obj.__assign(bb_pos + 12, bb);
    }

    public Vec3f translate() {
        return translate(new Vec3f());
    }

    public Vec3f translate(Vec3f obj) {
        return obj.__assign(bb_pos + 28, bb);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Transform get(int j) {
            return get(new Transform(), j);
        }

        public Transform get(Transform obj, int j) {
