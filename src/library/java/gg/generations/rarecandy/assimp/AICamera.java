...
public class AICamera extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AICamera, Buffer> implements NativeResource {
        ...
        public Buffer mName(@NativeType("struct aiString") AIString value) { AICamera.nmName(address(), value); return this; }
        ...
        public Buffer mPosition(@NativeType("struct aiVector3D") AIVector3D value) { AICamera.nmPosition(address(), value); return this; }
        /** Passes the {@link AICamera#mPosition} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mPosition(java.util.function.Consumer<AIVector3D> consumer) { consumer.accept(mPosition()); return this; }
        /** Copies the specified {@link AIVector3D} to the {@link AICamera#mUp} field. */
        public Buffer mUp(@NativeType("struct aiVector3D") AIVector3D value) { AICamera.nmUp(address(), value); return this; }
        /** Passes the {@link AICamera#mUp} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mUp(java.util.function.Consumer<AIVector3D> consumer) { consumer.accept(mUp()); return this; }
        /** Copies the specified {@link AIVector3D} to the {@link AICamera#mLookAt} field. */
        public Buffer mLookAt(@NativeType("struct aiVector3D") AIVector3D value) { AICamera.nmLookAt(address(), value); return this; }
        /** Passes the {@link AICamera#mLookAt} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mLookAt(java.util.function.Consumer<AIVector3D> consumer) { consumer.accept(mLookAt()); return this; }
        /** Sets the specified value to the {@link AICamera#mHorizontalFOV} field. */
        public Buffer mHorizontalFOV(float value) { AICamera.nmHorizontalFOV(address(), value); return this; }
        /** Sets the specified value to the {@link AICamera#mClipPlaneNear} field. */
        public Buffer mClipPlaneNear(float value) { AICamera.nmClipPlaneNear(address(), value); return this; }
        /** Sets the specified value to the {@link AICamera#mClipPlaneFar} field. */
        public Buffer mClipPlaneFar(float value) { AICamera.nmClipPlaneFar(address(), value); return this; }
        /** Sets the specified value to the {@link AICamera#mAspect} field. */
        public Buffer mAspect(float value) { AICamera.nmAspect(address(), value); return this; }
        /** Sets the specified value to the {@link AICamera#mOrthographicWidth} field. */
        public Buffer mOrthographicWidth(float value) { AICamera.nmOrthographicWidth(address(), value); return this; }
