...
public final class BoneTrack extends Table {
    ...
    public static BoneTrack getRootAsBoneTrack(ByteBuffer _bb) {
        return getRootAsBoneTrack(_bb, new BoneTrack());
    }

    public static BoneTrack getRootAsBoneTrack(ByteBuffer _bb, BoneTrack obj) {
    ...
    public BoneTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public ByteBuffer boneNameAsByteBuffer() {
        return __vector_as_bytebuffer(4, 1);
    }

    public ByteBuffer boneNameInByteBuffer(ByteBuffer _bb) {
    ...
    public Table translate(Table obj) {
        int o = __offset(16);
        return o != 0 ? __union(obj, o + bb_pos) : null;
    }
    ...
    public static void startBoneTrack(FlatBufferBuilder builder) {
        builder.startTable(7);
    }

    public static void addBoneName(FlatBufferBuilder builder, int boneNameOffset) {
        builder.addOffset(0, boneNameOffset, 0);
    }

    public static void addScaleType(FlatBufferBuilder builder, byte scaleType) {
        builder.addByte(1, scaleType, 0);
    }

    public static void addScale(FlatBufferBuilder builder, int scaleOffset) {
        builder.addOffset(2, scaleOffset, 0);
    }

    public static void addRotateType(FlatBufferBuilder builder, byte rotateType) {
        builder.addByte(3, rotateType, 0);
    }

    public static void addRotate(FlatBufferBuilder builder, int rotateOffset) {
        builder.addOffset(4, rotateOffset, 0);
    }

    public static void addTranslateType(FlatBufferBuilder builder, byte translateType) {
        builder.addByte(5, translateType, 0);
    }

    public static void addTranslate(FlatBufferBuilder builder, int translateOffset) {
        builder.addOffset(6, translateOffset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public BoneTrack get(int j) {
            return get(new BoneTrack(), j);
        }

        public BoneTrack get(BoneTrack obj, int j) {
    ...
    public void unpackTo(BoneTrackT _o) {
        String _oBoneName = boneName();
        _o.setBoneName(_oBoneName);
    ...
    public static int pack(FlatBufferBuilder builder, BoneTrackT _o) {
        if (_o == null) return 0;
        int _boneName = _o.getBoneName() == null ? 0 : builder.createString(_o.getBoneName());
