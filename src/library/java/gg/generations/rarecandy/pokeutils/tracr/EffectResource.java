...
public final class EffectResource extends Table {
    ...
    public static EffectResource getRootAsEffectResource(ByteBuffer _bb) {
        return getRootAsEffectResource(_bb, new EffectResource());
    }

    public static EffectResource getRootAsEffectResource(ByteBuffer _bb, EffectResource obj) {
    ...
    public EffectResource __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startEffectResource(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public EffectResource get(int j) {
            return get(new EffectResource(), j);
        }

        public EffectResource get(EffectResource obj, int j) {
