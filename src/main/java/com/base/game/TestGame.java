...
public class TestGame extends Game {
    public void Init() {
        ...
        GameObject animatedObject2 = new GameObject().AddComponent(AnimationUtil.loadAnimatedFile(new File("/test.glb")));
        animatedObject2.GetTransform().SetScale(new Vector3f(0.4f, 0.4f, 0.4f));
        animatedObject2.GetTransform().SetPos(new Vector3f(5, 5, 5f));
        AddObject(animatedObject2);
