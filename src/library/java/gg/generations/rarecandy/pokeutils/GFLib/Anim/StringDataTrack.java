...
public final class StringDataTrack extends Table {
    ...
    public static StringDataTrack getRootAsStringDataTrack(ByteBuffer _bb) {
        return getRootAsStringDataTrack(_bb, new StringDataTrack());
    }

    public static StringDataTrack getRootAsStringDataTrack(ByteBuffer _bb, StringDataTrack obj) {
    ...
    public StringDataTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startStringDataTrack(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public StringDataTrack get(int j) {
            return get(new StringDataTrack(), j);
        }

        public StringDataTrack get(StringDataTrack obj, int j) {
