...
public class AIQuatKey extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIQuatKey, Buffer> implements NativeResource {
        ...
        public Buffer mTime(double value) { AIQuatKey.nmTime(address(), value); return this; }
        /** Copies the specified {@link AIQuaternion} to the {@link AIQuatKey#mValue} field. */
        public Buffer mValue(@NativeType("struct aiQuaternion") AIQuaternion value) { AIQuatKey.nmValue(address(), value); return this; }
        /** Passes the {@link AIQuatKey#mValue} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mValue(java.util.function.Consumer<AIQuaternion> consumer) { consumer.accept(mValue()); return this; }
