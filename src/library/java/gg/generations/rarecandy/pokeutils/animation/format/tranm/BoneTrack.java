...
public final class BoneTrack extends Table {
  ...
  public String boneName() { int o = __offset(4); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer boneNameAsByteBuffer() { return __vector_as_bytebuffer(4, 1); }
  public ByteBuffer boneNameInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 4, 1); }
  ...
  public static void addBoneName(FlatBufferBuilder builder, int boneNameOffset) { builder.addOffset(0, boneNameOffset, 0); }
