...
public final class FixedByteTrack extends Table {
    ...
    public static FixedByteTrack getRootAsFixedByteTrack(ByteBuffer _bb) {
        return getRootAsFixedByteTrack(_bb, new FixedByteTrack());
    }

    public static FixedByteTrack getRootAsFixedByteTrack(ByteBuffer _bb, FixedByteTrack obj) {
    ...
    public FixedByteTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startFixedByteTrack(FlatBufferBuilder builder) {
        builder.startTable(1);
    }

    public static void addByte(FlatBufferBuilder builder, int byte_) {
        builder.addByte(0, (byte) byte_, (byte) 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public FixedByteTrack get(int j) {
            return get(new FixedByteTrack(), j);
        }

        public FixedByteTrack get(FixedByteTrack obj, int j) {
