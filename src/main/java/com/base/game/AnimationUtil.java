...
public class AnimationUtil {
    public static AnimatedComponent loadAnimatedFile(File file) {
        ...
        AIScene scene = Assimp.aiImportFileFromMemory(buffer, Assimp.aiProcess_Triangulate | Assimp.aiProcess_CalcTangentSpace | Assimp.aiProcess_LimitBoneWeights, extension);
