...
public final class Moves extends Table {
    ...
    public static Moves getRootAsMoves(ByteBuffer _bb) {
        return getRootAsMoves(_bb, new Moves());
    }

    public static Moves getRootAsMoves(ByteBuffer _bb, Moves obj) {
    ...
    public Moves __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startMoves(FlatBufferBuilder builder) {
        builder.startTable(4);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Moves get(int j) {
            return get(new Moves(), j);
        }

        public Moves get(Moves obj, int j) {
