...
public final class Trigger extends Table {
    ...
    public static Trigger getRootAsTrigger(ByteBuffer _bb) {
        return getRootAsTrigger(_bb, new Trigger());
    }

    public static Trigger getRootAsTrigger(ByteBuffer _bb, Trigger obj) {
    ...
    public Trigger __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startTrigger(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Trigger get(int j) {
            return get(new Trigger(), j);
        }

        public Trigger get(Trigger obj, int j) {
