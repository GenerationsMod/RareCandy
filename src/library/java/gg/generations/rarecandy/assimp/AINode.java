...
public class AINode extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AINode, Buffer> implements NativeResource {
        ...
        public Buffer mName(@NativeType("struct aiString") AIString value) { AINode.nmName(address(), value); return this; }
        ...
        public Buffer mTransformation(@NativeType("struct aiMatrix4x4") AIMatrix4x4 value) { AINode.nmTransformation(address(), value); return this; }
        /** Passes the {@link AINode#mTransformation} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mTransformation(java.util.function.Consumer<AIMatrix4x4> consumer) { consumer.accept(mTransformation()); return this; }
        /** Sets the address of the specified {@link AINode} to the {@link AINode#mParent} field. */
        public Buffer mParent(@Nullable @NativeType("struct aiNode *") AINode value) { AINode.nmParent(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AINode#mChildren} field. */
        public Buffer mChildren(@Nullable @NativeType("struct aiNode **") PointerBuffer value) { AINode.nmChildren(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@link AINode#mMeshes} field. */
        public Buffer mMeshes(@Nullable @NativeType("unsigned int *") IntBuffer value) { AINode.nmMeshes(address(), value); return this; }
        /** Sets the address of the specified {@link AIMetaData} to the {@link AINode#mMetadata} field. */
        public Buffer mMetadata(@Nullable @NativeType("struct aiMetadata *") AIMetaData value) { AINode.nmMetadata(address(), value); return this; }
