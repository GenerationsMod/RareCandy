...
public final class ConditionValue_Trigger extends Table {
  ...
  public static ConditionValue_Trigger getRootAsConditionValue_Trigger(ByteBuffer _bb, ConditionValue_Trigger obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public ConditionValue_Trigger get(int j) { return get(new ConditionValue_Trigger(), j); }
    public ConditionValue_Trigger get(ConditionValue_Trigger obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
