...
public final class TrackFlagsInfo extends Table {
    ...
    public static TrackFlagsInfo getRootAsTrackFlagsInfo(ByteBuffer _bb) {
        return getRootAsTrackFlagsInfo(_bb, new TrackFlagsInfo());
    }

    public static TrackFlagsInfo getRootAsTrackFlagsInfo(ByteBuffer _bb, TrackFlagsInfo obj) {
    ...
    public TrackFlagsInfo __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startTrackFlagsInfo(FlatBufferBuilder builder) {
        builder.startTable(2);
    }

    public static void addValuesType(FlatBufferBuilder builder, byte valuesType) {
        builder.addByte(0, valuesType, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public TrackFlagsInfo get(int j) {
            return get(new TrackFlagsInfo(), j);
        }

        public TrackFlagsInfo get(TrackFlagsInfo obj, int j) {
