...
public class Test extends Game {
    public void Init() {
        AddObject(new GameObject().AddComponent(new Camera(new Matrix4f().InitPerspective((float) Math.toRadians(90.0f),
        ...
        animatedObject.GetTransform().SetPos(new Vector3f(0, 2f, 10));
