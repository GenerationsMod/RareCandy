...
public final class Channels extends Table {
    ...
    public static Channels getRootAsChannels(ByteBuffer _bb) {
        return getRootAsChannels(_bb, new Channels());
    }

    public static Channels getRootAsChannels(ByteBuffer _bb, Channels obj) {
    ...
    public Channels __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public ChannelList list() {
        return list(new ChannelList());
    }

    public ChannelList list(ChannelList obj) {
        int o = __offset(4);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }

    public ChannelUnknown unk1() {
        return unk1(new ChannelUnknown());
    }

    public ChannelUnknown unk1(ChannelUnknown obj) {
        int o = __offset(6);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }

    public ChannelUnknown unk2() {
        return unk2(new ChannelUnknown());
    }

    public ChannelUnknown unk2(ChannelUnknown obj) {
        int o = __offset(8);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }
    ...
    public static void startChannels(FlatBufferBuilder builder) {
        builder.startTable(3);
    }
    ...
    public static void addUnk1(FlatBufferBuilder builder, int unk1Offset) {
        builder.addOffset(1, unk1Offset, 0);
    }

    public static void addUnk2(FlatBufferBuilder builder, int unk2Offset) {
        builder.addOffset(2, unk2Offset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Channels get(int j) {
            return get(new Channels(), j);
        }

        public Channels get(Channels obj, int j) {
