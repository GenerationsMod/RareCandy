...
public class FloatTrackUnion {
    ...
    public TrackProcesser<Float> getValue() {
        return value;
    }

    public void setValue(TrackProcesser<Float> value) {
        this.value = value;
    }
    ...
    public FixedFloatTrackT asFixedFloatTrack() {
        return (FixedFloatTrackT) value;
    }

    public DynamicFloatTrackT asDynamicFloatTrack() {
        return (DynamicFloatTrackT) value;
    }

    public Framed16FloatTrackT asFramed16FloatTrack() {
        return (Framed16FloatTrackT) value;
    }

    public Framed8FloatTrackT asFramed8FloatTrack() {
        return (Framed8FloatTrackT) value;
    }

    public static int pack(FlatBufferBuilder builder, FloatTrackUnion _o) {
        switch (_o.type) {
            case FloatTrack.FixedFloatTrack:
                return FixedFloatTrack.pack(builder, _o.asFixedFloatTrack());
            case FloatTrack.DynamicFloatTrack:
                return DynamicFloatTrack.pack(builder, _o.asDynamicFloatTrack());
            case FloatTrack.Framed16FloatTrack:
                return Framed16FloatTrack.pack(builder, _o.asFramed16FloatTrack());
            case FloatTrack.Framed8FloatTrack:
                return Framed8FloatTrack.pack(builder, _o.asFramed8FloatTrack());
            default:
                return 0;
        }
    }
