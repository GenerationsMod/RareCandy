...
public final class FloatDataTrack extends Table {
    ...
    public static FloatDataTrack getRootAsFloatDataTrack(ByteBuffer _bb) {
        return getRootAsFloatDataTrack(_bb, new FloatDataTrack());
    }

    public static FloatDataTrack getRootAsFloatDataTrack(ByteBuffer _bb, FloatDataTrack obj) {
    ...
    public FloatDataTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startFloatDataTrack(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public FloatDataTrack get(int j) {
            return get(new FloatDataTrack(), j);
        }

        public FloatDataTrack get(FloatDataTrack obj, int j) {
