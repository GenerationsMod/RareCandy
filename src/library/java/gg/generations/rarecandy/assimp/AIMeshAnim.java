...
public class AIMeshAnim extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIMeshAnim, Buffer> implements NativeResource {
        ...
        public Buffer mName(@NativeType("struct aiString") AIString value) { AIMeshAnim.nmName(address(), value); return this; }
        ...
        public Buffer mKeys(@NativeType("struct aiMeshKey *") AIMeshKey.Buffer value) { AIMeshAnim.nmKeys(address(), value); return this; }
