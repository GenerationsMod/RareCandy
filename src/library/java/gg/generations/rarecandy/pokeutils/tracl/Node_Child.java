...
public final class Node_Child extends Table {
    ...
    public static Node_Child getRootAsNode_Child(ByteBuffer _bb) {
        return getRootAsNode_Child(_bb, new Node_Child());
    }

    public static Node_Child getRootAsNode_Child(ByteBuffer _bb, Node_Child obj) {
    ...
    public Node_Child __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startNode_Child(FlatBufferBuilder builder) {
        builder.startTable(4);
    }

    public static void addIndex(FlatBufferBuilder builder, long index) {
        builder.addInt(0, (int) index, (int) 0L);
    }
    ...
    public static void addChannels(FlatBufferBuilder builder, int channelsOffset) {
        builder.addOffset(2, channelsOffset, 0);
    }

    public static void addUnk(FlatBufferBuilder builder, long unk) {
        builder.addInt(3, (int) unk, (int) 0L);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Node_Child get(int j) {
            return get(new Node_Child(), j);
        }

        public Node_Child get(Node_Child obj, int j) {
