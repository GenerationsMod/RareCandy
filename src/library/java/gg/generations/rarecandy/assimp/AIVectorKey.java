...
public class AIVectorKey extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIVectorKey, Buffer> implements NativeResource {
        ...
        public Buffer mTime(double value) { AIVectorKey.nmTime(address(), value); return this; }
        /** Copies the specified {@link AIVector3D} to the {@link AIVectorKey#mValue} field. */
        public Buffer mValue(@NativeType("struct aiVector3D") AIVector3D value) { AIVectorKey.nmValue(address(), value); return this; }
        /** Passes the {@link AIVectorKey#mValue} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mValue(java.util.function.Consumer<AIVector3D> consumer) { consumer.accept(mValue()); return this; }
