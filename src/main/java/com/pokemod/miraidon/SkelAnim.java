...
public final class SkelAnim extends Table {
  ...
  public com.pokemod.miraidon.Bone bones(int j) { return bones(new com.pokemod.miraidon.Bone(), j); }
  public com.pokemod.miraidon.Bone bones(com.pokemod.miraidon.Bone obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int bonesLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public com.pokemod.miraidon.Bone.Vector bonesVector() { return bonesVector(new com.pokemod.miraidon.Bone.Vector()); }
  public com.pokemod.miraidon.Bone.Vector bonesVector(com.pokemod.miraidon.Bone.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public com.pokemod.miraidon.BoneInit initData(int j) { return initData(new com.pokemod.miraidon.BoneInit(), j); }
  public com.pokemod.miraidon.BoneInit initData(com.pokemod.miraidon.BoneInit obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int initDataLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public com.pokemod.miraidon.BoneInit.Vector initDataVector() { return initDataVector(new com.pokemod.miraidon.BoneInit.Vector()); }
  public com.pokemod.miraidon.BoneInit.Vector initDataVector(com.pokemod.miraidon.BoneInit.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public static final class Vector extends BaseVector {
    ...
    public SkelAnim get(SkelAnim obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
