...
import gg.generations.rarecandy.pokeutils.animation.format.gfbanm.tracks._float.*;
...
public final class ShaderEntry extends Table {
  ...
  public static ShaderEntry getRootAsShaderEntry(ByteBuffer _bb) { return getRootAsShaderEntry(_bb, new ShaderEntry()); }
  public static ShaderEntry getRootAsShaderEntry(ByteBuffer _bb, ShaderEntry obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public ShaderEntry __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startShaderEntry(FlatBufferBuilder builder) { builder.startTable(3); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public ShaderEntry get(int j) { return get(new ShaderEntry(), j); }
    public ShaderEntry get(ShaderEntry obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
