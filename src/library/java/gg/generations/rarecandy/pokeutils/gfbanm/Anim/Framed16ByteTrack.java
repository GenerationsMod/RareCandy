...
public final class Framed16ByteTrack extends Table {
    ...
    public static Framed16ByteTrack getRootAsFramed16ByteTrack(ByteBuffer _bb) {
        return getRootAsFramed16ByteTrack(_bb, new Framed16ByteTrack());
    }

    public static Framed16ByteTrack getRootAsFramed16ByteTrack(ByteBuffer _bb, Framed16ByteTrack obj) {
    ...
    public Framed16ByteTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public ByteVector byteVector() {
        return byteVector(new ByteVector());
    }

    public ByteVector byteVector(ByteVector obj) {
        int o = __offset(6);
        return o != 0 ? obj.__assign(__vector(o), bb) : null;
    }

    public ByteBuffer byte_AsByteBuffer() {
        return __vector_as_bytebuffer(6, 1);
    }

    public ByteBuffer byte_InByteBuffer(ByteBuffer _bb) {
    ...
    public static void startFramed16ByteTrack(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static void addByte(FlatBufferBuilder builder, int byte_Offset) {
        builder.addOffset(1, byte_Offset, 0);
    }

    public static int createByteVector(FlatBufferBuilder builder, byte[] data) {
        return builder.createByteVector(data);
    }

    public static int createByteVector(FlatBufferBuilder builder, ByteBuffer data) {
        return builder.createByteVector(data);
    }

    public static void startByteVector(FlatBufferBuilder builder, int numElems) {
    ...
    public static final class Vector extends BaseVector {
        ...
        public Framed16ByteTrack get(int j) {
            return get(new Framed16ByteTrack(), j);
        }

        public Framed16ByteTrack get(Framed16ByteTrack obj, int j) {
    ...
    public void unpackTo(Framed16ByteTrackT _o) {
        ...
        for (int _j = 0; _j < byte_Length(); ++_j) {
            _oByte[_j] = byte_(_j);
        }
        _o.setByte(_oByte);
    }
