...
public final class Framed16VectorTrack extends Table {
  ...
  public com.pokemod.miraidon.Vec3f vec(com.pokemod.miraidon.Vec3f obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o) + j * 12, bb) : null; }
  ...
  public com.pokemod.miraidon.Vec3f.Vector vecVector(com.pokemod.miraidon.Vec3f.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 12, bb) : null; }
