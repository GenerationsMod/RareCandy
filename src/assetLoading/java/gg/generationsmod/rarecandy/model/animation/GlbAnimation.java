...
//
//public class GlbAnimation extends Animation<AIScene> {
//    public GlbAnimation(AIScene rawAnimation, Skeleton skeleton, int speed) {
//        super(rawAnimation.mName().dataString(), speed, skeleton, rawAnimation, GlbAnimation::fillAnimationNodes, Animation::fillOffsets);
//AIAnimation.
//        animationModifier.accept(this, "glb");
//    }
//
//    public static AnimationNode[] fillAnimationNodes(Animation<AIScene> animation, AIScene item) {
//        return fillAnimationNodesGlb(animation, AIAnimation.nmNumChannels( )item.a.getChannels());
//    }
//
