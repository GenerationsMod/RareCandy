...
public final class TrackResources extends Table {
    ...
    public static TrackResources getRootAsTrackResources(ByteBuffer _bb) {
        return getRootAsTrackResources(_bb, new TrackResources());
    }

    public static TrackResources getRootAsTrackResources(ByteBuffer _bb, TrackResources obj) {
    ...
    public TrackResources __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public AnimationResource animation() {
        return animation(new AnimationResource());
    }

    public AnimationResource animation(AnimationResource obj) {
        int o = __offset(4);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }

    public MaterialResource material() {
        return material(new MaterialResource());
    }

    public MaterialResource material(MaterialResource obj) {
        int o = __offset(6);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }

    public EffectResource effect() {
        return effect(new EffectResource());
    }

    public EffectResource effect(EffectResource obj) {
        int o = __offset(8);
        return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null;
    }
    ...
    public static void startTrackResources(FlatBufferBuilder builder) {
        builder.startTable(3);
    }

    public static void addAnimation(FlatBufferBuilder builder, int animationOffset) {
        builder.addOffset(0, animationOffset, 0);
    }

    public static void addMaterial(FlatBufferBuilder builder, int materialOffset) {
        builder.addOffset(1, materialOffset, 0);
    }

    public static void addEffect(FlatBufferBuilder builder, int effectOffset) {
        builder.addOffset(2, effectOffset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public TrackResources get(int j) {
            return get(new TrackResources(), j);
        }

        public TrackResources get(TrackResources obj, int j) {
