...
public final class TRACL extends Table {
    ...
    public static TRACL getRootAsTRACL(ByteBuffer _bb) {
        return getRootAsTRACL(_bb, new TRACL());
    }

    public static TRACL getRootAsTRACL(ByteBuffer _bb, TRACL obj) {
    ...
    public TRACL __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public Node_Root root() {
        return root(new Node_Root());
    }

    public Node_Root root(Node_Root obj) {
        int o = __offset(4);
    ...
    public static void startTRACL(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static void finishTRACLBuffer(FlatBufferBuilder builder, int offset) {
        builder.finish(offset);
    }

    public static void finishSizePrefixedTRACLBuffer(FlatBufferBuilder builder, int offset) {
    ...
    public static final class Vector extends BaseVector {
        ...
        public TRACL get(int j) {
            return get(new TRACL(), j);
        }

        public TRACL get(TRACL obj, int j) {
