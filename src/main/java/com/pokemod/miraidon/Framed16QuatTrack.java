...
public final class Framed16QuatTrack extends Table {
  ...
  public com.pokemod.miraidon.Vec3s vec(int j) { return vec(new com.pokemod.miraidon.Vec3s(), j); }
  public com.pokemod.miraidon.Vec3s vec(com.pokemod.miraidon.Vec3s obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o) + j * 6, bb) : null; }
  public int vecLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public com.pokemod.miraidon.Vec3s.Vector vecVector() { return vecVector(new com.pokemod.miraidon.Vec3s.Vector()); }
  public com.pokemod.miraidon.Vec3s.Vector vecVector(com.pokemod.miraidon.Vec3s.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 6, bb) : null; }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Framed16QuatTrack get(Framed16QuatTrack obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
