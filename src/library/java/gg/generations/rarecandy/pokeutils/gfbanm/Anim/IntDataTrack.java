...
public final class IntDataTrack extends Table {
    ...
    public static IntDataTrack getRootAsIntDataTrack(ByteBuffer _bb) {
        return getRootAsIntDataTrack(_bb, new IntDataTrack());
    }

    public static IntDataTrack getRootAsIntDataTrack(ByteBuffer _bb, IntDataTrack obj) {
    ...
    public IntDataTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startIntDataTrack(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public IntDataTrack get(int j) {
            return get(new IntDataTrack(), j);
        }

        public IntDataTrack get(IntDataTrack obj, int j) {
