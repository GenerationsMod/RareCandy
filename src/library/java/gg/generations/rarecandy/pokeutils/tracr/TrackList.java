...
public final class TrackList extends Table {
    ...
    public static TrackList getRootAsTrackList(ByteBuffer _bb) {
        return getRootAsTrackList(_bb, new TrackList());
    }

    public static TrackList getRootAsTrackList(ByteBuffer _bb, TrackList obj) {
    ...
    public TrackList __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public Track list(int j) {
        return list(new Track(), j);
    }

    public Track list(Track obj, int j) {
        int o = __offset(4);
    ...
    public Track.Vector listVector() {
        return listVector(new Track.Vector());
    }

    public Track.Vector listVector(Track.Vector obj) {
        int o = __offset(4);
    ...
    public static void startTrackList(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public TrackList get(int j) {
            return get(new TrackList(), j);
        }

        public TrackList get(TrackList obj, int j) {
    ...
    public static int pack(FlatBufferBuilder builder, TrackListT _o) {
        ...
        if (_o.getList() != null) {
            ...
            int _j = 0;
            for (TrackT _e : _o.getList()) {
                __list[_j] = Track.pack(builder, _e);
                _j++;
            }
