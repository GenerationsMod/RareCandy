...
public class ByteTrackUnion {
    ...
    public FixedByteTrackT asFixedByteTrack() {
        return (FixedByteTrackT) value;
    }

    public DynamicByteTrackT asDynamicByteTrack() {
        return (DynamicByteTrackT) value;
    }

    public Framed16ByteTrackT asFramed16ByteTrack() {
        return (Framed16ByteTrackT) value;
    }

    public Framed8ByteTrackT asFramed8ByteTrack() {
        return (Framed8ByteTrackT) value;
    }

    public static int pack(FlatBufferBuilder builder, ByteTrackUnion _o) {
        switch (_o.type) {
            case ByteTrack.FixedByteTrack:
                return FixedByteTrack.pack(builder, _o.asFixedByteTrack());
            case ByteTrack.DynamicByteTrack:
                return DynamicByteTrack.pack(builder, _o.asDynamicByteTrack());
            case ByteTrack.Framed16ByteTrack:
                return Framed16ByteTrack.pack(builder, _o.asFramed16ByteTrack());
            case ByteTrack.Framed8ByteTrack:
                return Framed8ByteTrack.pack(builder, _o.asFramed8ByteTrack());
            default:
                return 0;
        }
    }
