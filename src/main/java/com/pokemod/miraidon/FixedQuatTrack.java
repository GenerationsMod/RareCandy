...
public final class FixedQuatTrack extends Table {
  ...
  public com.pokemod.miraidon.Vec3s vec() { return vec(new com.pokemod.miraidon.Vec3s()); }
  public com.pokemod.miraidon.Vec3s vec(com.pokemod.miraidon.Vec3s obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public static final class Vector extends BaseVector {
    ...
    public FixedQuatTrack get(FixedQuatTrack obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
