...
public final class Switch extends Table {
    ...
    public static Switch getRootAsSwitch(ByteBuffer _bb) {
        return getRootAsSwitch(_bb, new Switch());
    }

    public static Switch getRootAsSwitch(ByteBuffer _bb, Switch obj) {
    ...
    public Switch __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startSwitch(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static void addVal(FlatBufferBuilder builder, boolean val) {
        builder.addBoolean(1, val, false);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Switch get(int j) {
            return get(new Switch(), j);
        }

        public Switch get(Switch obj, int j) {
