...
public final class SkelAnim extends Table {
    ...
    public static SkelAnim getRootAsSkelAnim(ByteBuffer _bb) {
        return getRootAsSkelAnim(_bb, new SkelAnim());
    }

    public static SkelAnim getRootAsSkelAnim(ByteBuffer _bb, SkelAnim obj) {
    ...
    public static void startSkelAnim(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static int createInitDataVector(FlatBufferBuilder builder, int[] data) {
        builder.startVector(4, data.length, 4);
        for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]);
        return builder.endVector();
    }

    public static void startInitDataVector(FlatBufferBuilder builder, int numElems) {
        builder.startVector(4, numElems, 4);
    }
    ...
    public SkelAnim __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public BoneInit initData(int j) {
        return initData(new BoneInit(), j);
    }

    public BoneInit initData(BoneInit obj, int j) {
        int o = __offset(6);
        return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null;
    }
    ...
    public BoneInit.Vector initDataVector(BoneInit.Vector obj) {
        int o = __offset(6);
        return o != 0 ? obj.__assign(__vector(o), 4, bb) : null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public SkelAnim get(int j) {
            return get(new SkelAnim(), j);
        }

        public SkelAnim get(SkelAnim obj, int j) {
