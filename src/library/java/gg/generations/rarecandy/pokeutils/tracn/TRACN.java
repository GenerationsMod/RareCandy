...
public final class TRACN extends Table {
    ...
    public static TRACN getRootAsTRACN(ByteBuffer _bb) {
        return getRootAsTRACN(_bb, new TRACN());
    }

    public static TRACN getRootAsTRACN(ByteBuffer _bb, TRACN obj) {
    ...
    public TRACN __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }

    public AnimationEntry list(int j) {
        return list(new AnimationEntry(), j);
    }

    public AnimationEntry list(AnimationEntry obj, int j) {
        int o = __offset(4);
    ...
    public AnimationEntry.Vector listVector() {
        return listVector(new AnimationEntry.Vector());
    }

    public AnimationEntry.Vector listVector(AnimationEntry.Vector obj) {
        int o = __offset(4);
    ...
    public static void startTRACN(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static void finishTRACNBuffer(FlatBufferBuilder builder, int offset) {
        builder.finish(offset);
    }

    public static void finishSizePrefixedTRACNBuffer(FlatBufferBuilder builder, int offset) {
    ...
    public static final class Vector extends BaseVector {
        ...
        public TRACN get(int j) {
            return get(new TRACN(), j);
        }

        public TRACN get(TRACN obj, int j) {
    ...
    public static int pack(FlatBufferBuilder builder, TRACNT _o) {
        ...
        if (_o.getList() != null) {
            ...
            int _j = 0;
            for (AnimationEntryT _e : _o.getList()) {
                __list[_j] = AnimationEntry.pack(builder, _e);
                _j++;
            }
