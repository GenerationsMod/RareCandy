...
import cf.hydos.animationRendering.engine.rendering.meshLoading.IndexedModel;
import cf.hydos.animationRendering.engine.rendering.meshLoading.OBJModel;
...
public class Mesh {
    private static final HashMap<String, MeshResource> s_loadedModels = new HashMap<String, MeshResource>();
