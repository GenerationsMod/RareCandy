...
public final class FixedVectorTrack extends Table {
  ...
  public com.pokemod.miraidon.Vec3f vec() { return vec(new com.pokemod.miraidon.Vec3f()); }
  public com.pokemod.miraidon.Vec3f vec(com.pokemod.miraidon.Vec3f obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
