...
public final class ConditionValue_Float extends Table {
  ...
  public static ConditionValue_Float getRootAsConditionValue_Float(ByteBuffer _bb, ConditionValue_Float obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public ConditionValue_Float get(int j) { return get(new ConditionValue_Float(), j); }
    public ConditionValue_Float get(ConditionValue_Float obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
