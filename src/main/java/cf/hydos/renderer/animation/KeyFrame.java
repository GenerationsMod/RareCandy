...
/**
 * Represents one keyframe of an com.thinmatrix.animationrenderer.animation. This contains the timestamp of the
 * keyframe, which is the time (in seconds) from the start of the com.thinmatrix.animationrenderer.animation when
 * this keyframe occurs.
 * <p>
 * It also contains the desired bone-space transforms of all of the joints in
 * the animated entity at this keyframe in the com.thinmatrix.animationrenderer.animation (i.e. it contains all
 * the joint transforms for the "pose" at this time of the com.thinmatrix.animationrenderer.animation.). The
...
public class KeyFrame {
    ...
    /**
     * @return The time in seconds of the keyframe in the com.thinmatrix.animationrenderer.animation.
     */
     ...
     * keyframe, of the com.thinmatrix.animationrenderer.animation, indexed by the name of the joint that
