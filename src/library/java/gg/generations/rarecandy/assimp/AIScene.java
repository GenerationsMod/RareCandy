...
public class AIScene extends Struct implements NativeResource {
    ...
    public PointerBuffer mSkeletons() { return nmSkeletons(address()); }
    ...
    public static class Buffer extends StructBuffer<AIScene, Buffer> implements NativeResource {
        ...
        @Nullable
        @NativeType("struct aiSkeleton **")
        public PointerBuffer mSkeletons() { return AIScene.nmSkeletons(address()); }

        /** Sets the specified value to the {@link AIScene#mFlags} field. */
        public Buffer mFlags(@NativeType("unsigned int") int value) { AIScene.nmFlags(address(), value); return this; }
        /** Sets the address of the specified {@link AINode} to the {@link AIScene#mRootNode} field. */
        public Buffer mRootNode(@Nullable @NativeType("struct aiNode *") AINode value) { AIScene.nmRootNode(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIScene#mMeshes} field. */
        public Buffer mMeshes(@Nullable @NativeType("struct aiMesh **") PointerBuffer value) { AIScene.nmMeshes(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIScene#mMaterials} field. */
        public Buffer mMaterials(@Nullable @NativeType("struct aiMaterial **") PointerBuffer value) { AIScene.nmMaterials(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIScene#mAnimations} field. */
        public Buffer mAnimations(@Nullable @NativeType("struct aiAnimation **") PointerBuffer value) { AIScene.nmAnimations(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIScene#mTextures} field. */
        public Buffer mTextures(@Nullable @NativeType("struct aiTexture **") PointerBuffer value) { AIScene.nmTextures(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIScene#mLights} field. */
        public Buffer mLights(@Nullable @NativeType("struct aiLight **") PointerBuffer value) { AIScene.nmLights(address(), value); return this; }
        /** Sets the address of the specified {@link PointerBuffer} to the {@link AIScene#mCameras} field. */
        public Buffer mCameras(@Nullable @NativeType("struct aiCamera **") PointerBuffer value) { AIScene.nmCameras(address(), value); return this; }
        /** Sets the address of the specified {@link AIMetaData} to the {@link AIScene#mMetaData} field. */
        public Buffer mMetaData(@Nullable @NativeType("struct aiMetadata *") AIMetaData value) { AIScene.nmMetaData(address(), value); return this; }
        /** Copies the specified {@link AIString} to the {@link AIScene#mName} field. */
        public Buffer mName(@NativeType("struct aiString") AIString value) { AIScene.nmName(address(), value); return this; }
        ...
        /** Sets the address of the specified {@link PointerBuffer} to the {@code mSkeletons} field. */
        public Buffer mSkeletons(@Nullable @NativeType("struct aiSkeleton **") PointerBuffer value) { AIScene.nmSkeletons(address(), value); return this; }
