...
public final class ColorEntry extends Table {
    ...
    public static ColorEntry getRootAsColorEntry(ByteBuffer _bb) {
        return getRootAsColorEntry(_bb, new ColorEntry());
    }

    public static ColorEntry getRootAsColorEntry(ByteBuffer _bb, ColorEntry obj) {
    ...
    public ColorEntry __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startColorEntry(FlatBufferBuilder builder) {
        builder.startTable(3);
    }
    ...
    public static void addColType(FlatBufferBuilder builder, byte colType) {
        builder.addByte(1, colType, 0);
    }

    public static void addCol(FlatBufferBuilder builder, int colOffset) {
        builder.addOffset(2, colOffset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ColorEntry get(int j) {
            return get(new ColorEntry(), j);
        }

        public ColorEntry get(ColorEntry obj, int j) {
