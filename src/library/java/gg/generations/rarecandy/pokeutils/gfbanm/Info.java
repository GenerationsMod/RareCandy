...
public final class Info extends Table {
    ...
    public static Info getRootAsInfo(ByteBuffer _bb) {
        return getRootAsInfo(_bb, new Info());
    }

    public static Info getRootAsInfo(ByteBuffer _bb, Info obj) {
    ...
    public Info __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public Info get(int j) {
            return get(new Info(), j);
        }

        public Info get(Info obj, int j) {
