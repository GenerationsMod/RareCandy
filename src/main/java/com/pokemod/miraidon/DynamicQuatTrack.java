...
public final class DynamicQuatTrack extends Table {
  ...
  public com.pokemod.miraidon.Vec3s vec(com.pokemod.miraidon.Vec3s obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o) + j * 6, bb) : null; }
  ...
  public com.pokemod.miraidon.Vec3s.Vector vecVector(com.pokemod.miraidon.Vec3s.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 6, bb) : null; }
  ...
  public static final class Vector extends BaseVector {
    ...
    public DynamicQuatTrack get(DynamicQuatTrack obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
