...
//import java.util.*;
//
//public class GfbAnimation extends Animation {
//
...
//
//                var offset = new GfbOffset(uOffset, vOffset, uScale, vScale, (float) duration);
//
...
//    }
//
//    public record GfbOffset(TransformStorage<Float> uOffset, TransformStorage<Float> vOffset, TransformStorage<Float> uScale, TransformStorage<Float> vScale, float duration) implements Offset {
