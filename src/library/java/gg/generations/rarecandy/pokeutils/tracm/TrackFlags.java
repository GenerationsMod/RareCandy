...
public final class TrackFlags extends Table {
    ...
    public static TrackFlags getRootAsTrackFlags(ByteBuffer _bb) {
        return getRootAsTrackFlags(_bb, new TrackFlags());
    }

    public static TrackFlags getRootAsTrackFlags(ByteBuffer _bb, TrackFlags obj) {
    ...
    public TrackFlags __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public TrackFlagsInfo info() {
        return info(new TrackFlagsInfo());
    }

    public TrackFlagsInfo info(TrackFlagsInfo obj) {
        int o = __offset(8);
    ...
    public static void startTrackFlags(FlatBufferBuilder builder) {
        builder.startTable(3);
    }
    ...
    public static void addInfo(FlatBufferBuilder builder, int infoOffset) {
        builder.addOffset(2, infoOffset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public TrackFlags get(int j) {
            return get(new TrackFlags(), j);
        }

        public TrackFlags get(TrackFlags obj, int j) {
