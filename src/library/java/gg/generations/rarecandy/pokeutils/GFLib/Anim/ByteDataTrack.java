...
public final class ByteDataTrack extends Table {
    ...
    public static ByteDataTrack getRootAsByteDataTrack(ByteBuffer _bb) {
        return getRootAsByteDataTrack(_bb, new ByteDataTrack());
    }

    public static ByteDataTrack getRootAsByteDataTrack(ByteBuffer _bb, ByteDataTrack obj) {
    ...
    public ByteDataTrack __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static void startByteDataTrack(FlatBufferBuilder builder) {
        builder.startTable(1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ByteDataTrack get(int j) {
            return get(new ByteDataTrack(), j);
        }

        public ByteDataTrack get(ByteDataTrack obj, int j) {
