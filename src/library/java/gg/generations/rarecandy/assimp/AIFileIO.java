...
public class AIFileIO extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AIFileIO, Buffer> implements NativeResource {
        ...
        public Buffer OpenProc(@NativeType("aiFileOpenProc") AIFileOpenProcI value) { AIFileIO.nOpenProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFileIO#CloseProc} field. */
        public Buffer CloseProc(@NativeType("aiFileCloseProc") AIFileCloseProcI value) { AIFileIO.nCloseProc(address(), value); return this; }
        /** Sets the specified value to the {@link AIFileIO#UserData} field. */
        public Buffer UserData(@NativeType("aiUserData") long value) { AIFileIO.nUserData(address(), value); return this; }
