...
public class GLFWDemo {
    ...
    public NuklearComponent component = new WindowComponent("Blep", 0f, 0f, () -> width, () -> height, new HorizontalMenuComponent(default_font, 
            new SubmenuComponent()
    ));

    public GLFWDemo() {
        try {
            this.ttf = ioResourceToByteBuffer("font.ttf", 512 * 1024);
        } catch (IOException e) {
        ...
        if (path != null && Files.isReadable(path)) {
            ...
            try (
                    InputStream source = resource.startsWith("http")
                            ...
                            : GLFWDemo.class.getClassLoader().getResourceAsStream(resource);
