...
public class Animation {
	 ...
	 *            - the total length of the com.thinmatrix.animationrenderer.animation in seconds.
	 * @param frames
	 *            - all the keyframes for the com.thinmatrix.animationrenderer.animation, ordered by time of
