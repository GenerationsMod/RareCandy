...
public class AISkeletonBone extends Struct implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<AISkeletonBone, Buffer> implements NativeResource {
        ...
        public Buffer mParent(int value) { AISkeletonBone.nmParent(address(), value); return this; }
        /** Sets the address of the specified {@link AINode} to the {@link AISkeletonBone#mArmature} field. */
        public Buffer mArmature(@Nullable @NativeType("struct aiNode *") AINode value) { AISkeletonBone.nmArmature(address(), value); return this; }
        /** Sets the address of the specified {@link AINode} to the {@link AISkeletonBone#mNode} field. */
        public Buffer mNode(@Nullable @NativeType("struct aiNode *") AINode value) { AISkeletonBone.nmNode(address(), value); return this; }
        /** Sets the specified value to the {@link AISkeletonBone#mNumnWeights} field. */
        public Buffer mNumnWeights(@NativeType("unsigned int") int value) { AISkeletonBone.nmNumnWeights(address(), value); return this; }
        /** Sets the address of the specified {@link AIMesh.Buffer} to the {@link AISkeletonBone#mMeshId} field. */
        public Buffer mMeshId(@NativeType("struct aiMesh *") AIMesh.Buffer value) { AISkeletonBone.nmMeshId(address(), value); return this; }
        /** Sets the address of the specified {@link AIVertexWeight.Buffer} to the {@link AISkeletonBone#mWeights} field. */
        public Buffer mWeights(@NativeType("struct aiVertexWeight *") AIVertexWeight.Buffer value) { AISkeletonBone.nmWeights(address(), value); return this; }
        /** Copies the specified {@link AIMatrix4x4} to the {@link AISkeletonBone#mOffsetMatrix} field. */
        public Buffer mOffsetMatrix(@NativeType("struct aiMatrix4x4") AIMatrix4x4 value) { AISkeletonBone.nmOffsetMatrix(address(), value); return this; }
        /** Passes the {@link AISkeletonBone#mOffsetMatrix} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mOffsetMatrix(java.util.function.Consumer<AIMatrix4x4> consumer) { consumer.accept(mOffsetMatrix()); return this; }
        /** Copies the specified {@link AIMatrix4x4} to the {@link AISkeletonBone#mLocalMatrix} field. */
        public Buffer mLocalMatrix(@NativeType("struct aiMatrix4x4") AIMatrix4x4 value) { AISkeletonBone.nmLocalMatrix(address(), value); return this; }
        /** Passes the {@link AISkeletonBone#mLocalMatrix} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer mLocalMatrix(java.util.function.Consumer<AIMatrix4x4> consumer) { consumer.accept(mLocalMatrix()); return this; }
