...
public final class AnimationInfo extends Table {
  ...
  public static AnimationInfo getRootAsAnimationInfo(ByteBuffer _bb, AnimationInfo obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public long animationCount() { int o = __offset(6); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  public long animationRate() { int o = __offset(8); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  ...
  public static void startAnimationInfo(FlatBufferBuilder builder) { builder.startTable(3); }
  public static void addDoesLoop(FlatBufferBuilder builder, long doesLoop) { builder.addInt(0, (int) doesLoop, (int) 0L); }
  public static void addAnimationCount(FlatBufferBuilder builder, long animationCount) { builder.addInt(1, (int) animationCount, (int) 0L); }
  public static void addAnimationRate(FlatBufferBuilder builder, long animationRate) { builder.addInt(2, (int) animationRate, (int) 0L); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public AnimationInfo get(int j) { return get(new AnimationInfo(), j); }
    public AnimationInfo get(AnimationInfo obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
