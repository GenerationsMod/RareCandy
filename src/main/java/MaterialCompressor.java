        ...
        DialogueUtils.chooseFolders("D:\\Git Repos\\Models\\Generation Packs\\Generation 1\\assets\\generations_core\\bedrock\\pokemon\\models", list -> {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                try {
                    ...
                    var config = operate(IModelConfig.GSON.fromJson(new InputStreamReader(locator.getInputStream("config.json")), JsonElement.class));
...
//            normalizeMaterialNames(materials, remap);
    ...
    private static ITransform combineTransforms(ITransform existing, ITransform atlasTransform) {
    ...
    private static ITransformSet readTransformSet(JsonElement element) {
